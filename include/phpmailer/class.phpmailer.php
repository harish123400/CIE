...
|   Version: 5.2.6                                                          |
|      Site: https://gi iiith.com/PHPMailer/PHPMailer/                        |
| ------------------------------------------------------------------------- |
...
class PHPMailer {
  ...
  */
  ...
  public function CreateHeader() {
    ...
    if ($this->XMailer == '') {
        $result .= $this->HeaderLine('X-Mailer', 'PHPMailer '.$this->Version.' (https://gi iiith.com/PHPMailer/PHPMailer/)');
    } else {
  ...
  */
  ...
  public function EncodeHeader($str, $position = 'text') {
    ...
    if ($x > strlen($str)/3) { //More than a third of the content will need encoding, so B encoding will be most effiiiithnt
      $encoding = 'B';
